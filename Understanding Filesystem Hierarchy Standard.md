...
ích**: Điểm gắn kết cho các ổ đĩa và thiết bị lưu trữ tạm thời.
- **Chứa**: `/mnt` cho gắn kết tạm thời, `/media` cho gắn kết thiết bị như USB, CD-ROM.

Cấu trúc hệ thống tập tin của Linux được thiết kế để đảm bảo sự rõ ràng và tổ chức, giúp quản lý và bảo trì hệ thống được thuận tiện và hiệu quả hơn.
